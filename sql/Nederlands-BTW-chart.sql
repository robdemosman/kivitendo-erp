...
VALUES
 ...
 ('011200', 'Auto', 																	'A', 'A', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('011102', 'investeringen Machines en installaties', 									'A', 'A', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('011002', 'Investeringen Bedrijfsgebouwen en -terreinen', 							'A', 'A', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('302000', 'Voorraad onderhanden werk', 												'A', 'A', '', 										12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('300000', 'Voorraad grondstoffen', 													'A', 'A', 'IC', 									0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('305000', 'Voorruitbetalingen op voorraden', 											'A', 'A', '', 										12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('420001', 'Verzekeringskosten', 														'A', 'E', 'AP_amount', 								11, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('301000', 'Voorraad hulpstoffen', 													'A', 'A', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('440001', 'Autoverzekering', 															'A', 'E', 'AP_amount', 								11, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('400301', 'Boekwinst Goodwill', 														'A', 'E', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('401101', 'Boekwinst Machines', 														'A', 'E', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('401200', 'Afschrijving Auto', 														'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('401201', 'Boekwinst Auto', 															'A', 'E', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('430003', 'kleine aanschaffingen Machines', 											'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('460000', 'Kantoorbenodigdheden', 													'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440003', 'Boetes en bekeuringen', 													'A', 'E', 'AP_amount', 								11, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('800300', 'Omzet uitbesteed werk', 													'A', 'I', 'AR_amount:IC_sale:IC_income', 			2, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440005', 'leasekosten', 																'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('800100', 'Omzet Print/Copy', 														'A', 'I', 'AR_amount:IC_sale:IC_income', 			2, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450005', 'Reis-en verblijfkosten', 													'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('710000', 'Voorraadmutaties', 														'A', 'C', '', 										12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450001', 'Kosten sponsoring', 														'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('700000', 'Inkoopwaarde van de omzet (inkooprijs van alle verkochte producten)', 		'A', 'C', 'IC_cogs', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('470000', 'Branche specifieke kosten', 												'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450007', 'Vrachtkosten uitgaande zendingen', 										'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450003', 'Relatiegeschenken', 														'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('460002', 'Onderhoud en reparaties kantoor', 											'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440007', 'Btw privégebruik auto', 													'A', 'E', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('460003', 'Porti', 																	'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('46', 	'Kantoorkosten', 															'A', 'E', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420005', 'Onroerende Zaak Belasting', 												'A', 'E', 'AP_amount', 								3, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('800200', 'Omzet LFP', 																'A', 'I', 'AR_amount:IC_sale:IC_income', 			2, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('480000', 'Abonnementen en contributies', 											'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('800000', 'Omzet Offset', 															'A', 'I', 'AR_amount:IC_sale:IC_income', 			2, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('800400', 'Omzet diverse', 															'A', 'I', 'AR_amount:IC_sale:IC_income', 			2, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('460004', 'Automatiseringskosten', 													'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ...
 ('480002', 'Administratiekosten', 														'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('49', 	'Bankkosten', 																'H', ' ', '',										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('480003', 'Accountantskosten', 														'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('460001', 'Communicatiekosten', 														'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450006', 'Vrachtkosten inkomende zendingen', 										'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450004', 'Representatiekosten', 														'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('450000', 'Reclame en advertentiekosten', 											'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440004', 'onderhoud en reparaties auto', 											'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440002', 'Motorrijtuigenbelasting', 													'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('440000', 'Brandstofkosten', 															'A', 'E', 'AP_amount', 								1, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('430001', 'Service kosten Machines', 													'A', 'E', 'AP_amount', 								1, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('430005', 'werk door derden', 														'A', 'E', 'AP_amount', 								11, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('430004', 'gereedschapskosten Machines', 												'A', 'E', 'AP_amount', 								0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('80', 	'netto Omzet', 																'H', ' ', '', 										0, 	NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('430000', 'Onderhoud en reparaties Machines', 										'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420007', 'Service kosten huur reclamebord', 											'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420008', 'Overige huisvestingskosten', 												'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420003', 'Gas, water en electra', 													'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420002', 'Onderhoud en reparaties huisvestiging', 									'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
 ('420000', 'Betaalde huur', 															'A', 'E', 'AP_amount', 								12, NULL, NULL, NULL, NULL, NULL, '1970-01-01'),
