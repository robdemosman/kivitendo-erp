...
sub to_xml {
 ...
 # my $pain_id   = $is_coll ? 'pain.008.002.02'   : 'pain.001.002.03';   ivm het niet accepteren van de bestanden door ABN-AMRO
  my $pain_id   = $is_coll ? 'pain.008.002.02'   : 'pain.001.001.03';
