...
sub report {
  ...
  print($form->parse_html_template('btw/report', $template_ref));
...
sub generate_btw {
  ...
  if ($form->{format} eq 'generic'){
    ...
    print($form->parse_html_template('btw/generic_taxreport', $template_ref));
  ...
  } else
  {
   ...
   $form->header;
   print $form->parse_html_template('btw/btw');
